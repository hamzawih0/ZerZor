...
export async function generateMetadata({
  ...
  const baseUrl = process.env.NEXT_PUBLIC_BASE_URL || "https://zormail.app"
  ...
  return {
    ...
    keywords: t("keywords"),
    authors: [{ name: "ZorMail Team" }],
    creator: "ZorMail Team",
    publisher: "ZorMail Team",
    robots: {
      index: true,
      follow: true,
      googleBot: {
...
export default async function LocaleLayout({
  ...
  return (
    <html lang={locale} suppressHydrationWarning>
      <head>
        <meta name="application-name" content="ZorMail" />
        <meta name="apple-mobile-web-app-capable" content="yes" />
        <meta name="apple-mobile-web-app-status-bar-style" content="default" />
        <meta name="apple-mobile-web-app-title" content="ZorMail" />
