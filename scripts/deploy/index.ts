...
const PROJECT_NAME = process.env.PROJECT_NAME || "zormail";
const DATABASE_NAME = process.env.DATABASE_NAME || "zormail-db";
const KV_NAMESPACE_NAME = process.env.KV_NAMESPACE_NAME || "zormail-kv";
